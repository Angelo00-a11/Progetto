...
public class Login extends JDialog {
    ...
    private void onOK() {
        ...
        if (ruolo.equalsIgnoreCase("Cliente")) {
            FormListaRistoranti FormCliente = new FormListaRistoranti();
            JFrame framelistaRistoranti = new JFrame();
            framelistaRistoranti.setTitle("ListaRistoranti");
            framelistaRistoranti.setContentPane(FormCliente.contentPane);
            framelistaRistoranti.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            framelistaRistoranti.setResizable(false);
            framelistaRistoranti.pack();
            framelistaRistoranti.setLocationRelativeTo(null);
            framelistaRistoranti.setVisible(true);
        } else if (ruolo.equalsIgnoreCase("Ristoratore")) {
            FormGestioneRistorante FormRistorante = new FormGestioneRistorante();
            JFrame frameGestioneRistorante = new JFrame();
            frameGestioneRistorante.setTitle("GestisciRistorante");
            frameGestioneRistorante.setContentPane(FormRistorante.contentPane);
            frameGestioneRistorante.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            frameGestioneRistorante.setResizable(false);
            frameGestioneRistorante.pack();
            frameGestioneRistorante.setLocationRelativeTo(null);
            frameGestioneRistorante.setVisible(true);
        }
