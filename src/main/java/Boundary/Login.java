...
public class Login extends JDialog {
    ...
    private void onOK() {
        ...
        // codice per verificare i parametri inseriti e SE corrisopondono ad un utente
        // registrato accade quanto segue:
        ...
        if (!esito) {
            JOptionPane.showMessageDialog(contentPane,
                    "Email non trovata o ruolo non corrispondente.",
                    "Login fallito", JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    private void $$$setupUI$$$() {
        ...
        panel3.add(spacer1, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER,
